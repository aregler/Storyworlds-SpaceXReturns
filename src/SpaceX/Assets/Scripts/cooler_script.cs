...
public class cooler_script : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            Debug.Log("Hineinklettern");
            playerInRange = false;
            GameObject.Find("Player").GetComponent<CharacterController>().enabled = false;
            GameObject.Find("Player").transform.position = pos.transform.position;
    ...
    IEnumerator fadeTextToFullAlpha(float timer)
    {
        ...
        actionText.text = "Hineinklettern (F)";
